                ...
                <div class="col-lg-3 col-12">
                    ...
                    <div class="product-sidebar">
                        ...
                        <div class="single-widget">
                            ...
                            <ul class="list">
                                <li>
                                    <a href="product-grids.html">Aquarium</a><span></span>
                                </li>
                                <li>
                                    <a href="product-grids.html">Air Pumps</a><span>)</span>
                                </li>
                                <li>
                                    <a href="product-grids.html">Water Pumps</a><span></span>
                                </li>
                                <li>
                                    <a href="product-grids.html">Accessories</a><span></span>
                                </li>
                                <li>
                                    <a href="product-grids.html">Goldfish</a><span></span>
                                </li>
                                <li>
                                    <a href="product-grids.html">Tools</a><span></span>
                                </li>
                            </ul>
                        </div>
                        <!-- End Single Widget -->
                            ...
                            <div class="tab-pane fade show active" id="nav-grid" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="{{ asset('/images/images/product_1.jpg') }}" alt="#">
                                                <div class="button">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="{{ asset('/images/images/product_9.jpg') }}" alt="#">
                                                <div class="button">
                                                    <a href="product-details.html" class="btn"><i
                                                            class="lni lni-cart"></i> Add to Cart</a>
                                                </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="{{ asset('/images/images/product_19.jpg') }}" alt="#">
                                                <div class="button">
                                                    <a href="product-details.html" class="btn"><i
                                                            class="lni lni-cart"></i> Add to Cart</a>
                                                </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="{{ asset('/images/images/product_7.jpg') }}" alt="#">
                                                <div class="button">
                                                    <a href="product-details.html" class="btn"><i
                                                            class="lni lni-cart"></i> Add to Cart</a>
                                                </div>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-12">
                                                    <div class="product-info">
                                                        <span class="category">Headphones</span>
                                                        <h4 class="title">
                                                            <a href="product-grids.html">Product 14</a>
                                                        </h4>
                                                        <ul class="review">
                                                            <li><i class="lni lni-star-filled"></i></li>
                                                            <li><i class="lni lni-star-filled"></i></li>
